        ...
        <div className="container" id="organizations">
            <div className="container__pagination">
                ...
                <div className="option__box">
                    <div
                        onClick={() => setPage(0)}
                        className={page === 0 ? 'active' : undefined}
                    >
                        Foundations
                    </div>
                    <div
                ...
                <p>
                    ...
                    Aliquam doloribus facere fugiat in libero maiores natus
                    obcaecati velit veniam. Aliquam autem dicta eaque eos
                    explicabo inventore perspiciatis ratione, rerum ut.5
                </p>
